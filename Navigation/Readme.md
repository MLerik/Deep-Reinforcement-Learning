...
2. Place the file in te in the `Navigation/` folder, and unzip (or decompress) the file. 
...
Read the report to see details about the chosen model, hyperparameters and additional considerations
